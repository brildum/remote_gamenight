...
module Sinatra::Delegator
  def after_reload(*args, &block); end
  def also_reload(*args, &block); end
  def config_file(*args, &block); end
  def dont_reload(*args, &block); end
...
class Sinatra::Reloader::Watcher::Element < Anonymous_Struct_7
end
...
module Sinatra::Reloader::BaseMethods
  def add_filter(type, path = nil, options = nil, &block); end
  def compile!(verb, path, block, options = nil); end
  def error(*codes, &block); end
  def inherited(subclass); end
  def inline_templates=(file = nil); end
  def register(*extensions, &block); end
  def run!(*args); end
...
module Sinatra::Reloader::ExtensionMethods
  ...
  def watch_element(path, type, representation = nil); end
end
