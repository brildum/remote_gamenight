...
Amatch::DiceCoefficient = Amatch::PairDistance
...
module Jobs::Events::EventHandler
  extend ::T::Sig
end
...
class Object
  ...
  STOPWORDS = ::T.let(nil, ::T.untyped)
  STOPWORDS_RAW = ::T.let(nil, ::T.untyped)
...
class Slack::Team
  include ::Slack::Team::GeneratedAssociationMethods
end

module Slack::Team::GeneratedAssociationMethods
end
...
class Trivia::Category
  include ::Trivia::Category::GeneratedAssociationMethods
  def after_add_for_clues(); end

  def after_add_for_clues=(val); end

  def after_add_for_clues?(); end

  def after_remove_for_clues(); end

  def after_remove_for_clues=(val); end

  def after_remove_for_clues?(); end

  def autosave_associated_records_for_clues(*args); end

  def before_add_for_clues(); end

  def before_add_for_clues=(val); end

  def before_add_for_clues?(); end

  def before_remove_for_clues(); end

  def before_remove_for_clues=(val); end

  def before_remove_for_clues?(); end

  def validate_associated_records_for_clues(*args); end
end

module Trivia::Category::GeneratedAssociationMethods
  def clue_ids(); end

  def clue_ids=(ids); end
...
class Trivia::Category
  def self.after_add_for_clues(); end

  def self.after_add_for_clues=(val); end

  def self.after_add_for_clues?(); end

  def self.after_remove_for_clues(); end

  def self.after_remove_for_clues=(val); end

  def self.after_remove_for_clues?(); end

  def self.before_add_for_clues(); end

  def self.before_add_for_clues=(val); end

  def self.before_add_for_clues?(); end

  def self.before_remove_for_clues(); end

  def self.before_remove_for_clues=(val); end

  def self.before_remove_for_clues?(); end
end

class Trivia::Clue
  include ::Trivia::Clue::GeneratedAssociationMethods
  def autosave_associated_records_for_category(*args); end

  def belongs_to_counter_cache_after_update(reflection); end
end

module Trivia::Clue::GeneratedAssociationMethods
